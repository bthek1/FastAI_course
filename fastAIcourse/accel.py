"""Docs: https://bthek1.github.io/fastAIcourse/ddpm_v2.html.md"""
...
# %% ../nbs/270_DDPM_v2.ipynb #ca2ebda3
...
# %% ../nbs/270_DDPM_v2.ipynb #1196c9e8
def noisify(x0, ᾱ):
    device = x0.device
    n = len(x0)
...
# %% ../nbs/270_DDPM_v2.ipynb #1063a003
from diffusers import UNet2DModel

# %% ../nbs/270_DDPM_v2.ipynb #7bcd1517
@torch.no_grad()
...
# %% ../nbs/270_DDPM_v2.ipynb #aa916302-00c5-4ec0-ac69-de4dccce755f
...
# %% ../nbs/270_DDPM_v2.ipynb #9a42927a
class UNet(UNet2DModel):
    def forward(self, x): return super().forward(*x).sample

# %% ../nbs/270_DDPM_v2.ipynb #3f4b4ada
def init_ddpm(model):
...
# %% ../nbs/270_DDPM_v2.ipynb #09b50882
def collate_ddpm(b): return noisify(default_collate(b)[xl], alphabar)
def dl_ddpm(ds): return DataLoader(ds, batch_size=bs, collate_fn=collate_ddpm, num_workers=4)

# %% ../nbs/270_DDPM_v2.ipynb #835174c0
...
# %% ../nbs/270_DDPM_v2.ipynb #8432b05e
from accelerate import Accelerator

# %% ../nbs/270_DDPM_v2.ipynb #4634d362
...
# %% ../nbs/270_DDPM_v2.ipynb #dde9d6a7
def noisify(x0, ᾱ):
    device = x0.device
    n = len(x0)
    t = torch.randint(0, n_steps, (n,), dtype=torch.long)
